...
excerpt: >
  ...
  les petits (et parfois _inaperçus_ ?) changements qui,
...
vous connaissez déjà tout sur les principales fonctionnalités
d'iOS 12 :
...
Mais chez NSHipster,
nous nous intéressons aux détails :
les petits (et souvent _inaperçus_) changements qui,
...
(Prudence, toutefois, car plusieurs d'entre-elles restent non-documentés).
...
est un mécanisme permettant de prioriser le traffic sans-fil selon le contenu transporté,
tel que de l'audio, de la vidéo, ou des données d'arrière-plan.
Il s'agit d'une technologie spécifique aux routeurs Cisco,
(qui fond transiter, à peu près, la moitié du traffic internet mondial),
...
[802.11k](https://en.wikipedia.org/wiki/IEEE_802.11k-2008) pour l'itinérante assistée, et
...
les développeurs iOS peuvent désormais exploiter à cette technologie en [déclarant la qualité de service souhaitée](https://developer.cisco.com/site/fast-lane/)
...
L'example qu'ils fournissent est celui de la validation de commande sur une app de e-commerce,
...
Aucune configuration additionnelle ne sera requise.
...
afin de laisser libre champ aux algorithmes de suivi de position les plus appropriés à ce cas de figure !
...
## Pré-remplir les nouveaux mots de passes et codes à usage unique
...
Pour réduire autant que possible cette corvée,
...
il est possible de déclarer quel catégorie d'information est attendue,
...
iOS 12 et tvOS 12 vont plus loin dans cette approche en ajoutant deux nouveaux type de contenus:
...
Lorsque `.oneTimeCode` sera spécifié,
